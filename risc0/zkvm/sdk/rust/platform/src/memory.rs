...
pub const WOM: Region = Region::new(0x02C0_0000, mb(21));
pub const OUTPUT: Region = Region::new(0x02C0_0000, mb(20));
pub const COMMIT: Region = Region::new(0x0400_0000, mb(1));
